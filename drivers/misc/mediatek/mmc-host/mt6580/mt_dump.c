...
static unsigned int simp_mmc_enable_clk(struct simp_mmc_host *host)
{
	...
	sdr_set_field((msdc_topckgen_base + 30), 0x1 << 0, 1); /* mainpll_D2 */
	sdr_set_field((msdc_topckgen_base + 30), 0x1 << 8, 1); /* mainpll_D4 */
	sdr_set_field((msdc_topckgen_base + 30), 0x1 << 16, 1); /* mainpll_D8 */
